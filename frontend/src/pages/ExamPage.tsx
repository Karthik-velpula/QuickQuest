    ...
    <div className="flex min-h-screen flex-col bg-canvas">
      ...
      <main className="grid flex-1 place-items-center px-4 py-6 sm:px-6 sm:py-10">
        <section className="w-full max-w-6xl rounded-2xl bg-white p-5 shadow-panel sm:p-8 md:p-12">
          ...
          <div className={`mt-6 grid gap-6 ${question.passage ? "lg:grid-cols-[1.05fr_0.95fr]" : ""}`}>
            {question.passage && (
              <aside className="rounded-2xl border border-slate-200 bg-slate-50 p-5 md:p-6 lg:sticky lg:top-6 lg:self-start">
                <p className="text-xs font-bold uppercase tracking-[0.2em] text-slate-500">Passage</p>
